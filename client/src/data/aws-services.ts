...
// Each service has an id, name, category, SVG icon path data, and description
...
export const AWS_SERVICES: AWSService[] = [
  ...
  },
  {
    ...
    iconPath: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 5l5 3v6l-5 3-5-3V10l5-3z',
  },
  {
    ...
    iconPath: 'M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm0 3a7 7 0 110 14 7 7 0 010-14z',
  },
  {
    ...
    iconPath: 'M12 2v4m0 12v4M6 12H2m20 0h-4m-1.5-6.5L18 4m-12 0 1.5 1.5m0 13L6 20m12 0-1.5-1.5M12 8a4 4 0 100 8 4 4 0 000-8z',
  },
  ...
  // ── Database ───────────────────────────────────────────────────────
  {
    ...
    iconPath: 'M12 2C7 2 3 3.8 3 6v12c0 2.2 4 4 9 4s9-1.8 9-4V6c0-2.2-4-4-9-4zm0 4c5 0 9-1.8 9-4M3 6c0 2.2 4 4 9 4s9-1.8 9-4M3 12c0 2.2 4 4 9 4s9-1.8 9-4',
  },
  {
    ...
    iconPath: 'M12 2l-8 4v12l8 4 8-4V6l-8-4zm0 8l-8-4m8 4l8-4m-8 4v10',
  },
  {
    ...
    iconPath: 'M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm0 4a6 6 0 110 12 6 6 0 010-12zm0 2a4 4 0 100 8 4 4 0 000-8z',
  },
  {
    ...
    iconPath: 'M12 2L2 7v10l10 5 10-5V7L12 2zm0 4l6 3v6l-6 3-6-3V9l6-3z',
  },
  {
    id: 'redshift', name: 'Amazon Redshift', shortName: 'Redshift', category: 'Database',
    color: '#C925D1', description: 'Data warehousing service',
    iconPath: 'M12 2a10 10 0 100 20 10 10 0 000-20zm-2 5h4v3h3l-5 5-5-5h3V7z',
  },
  {
    ...
    iconPath: 'M6 2h12v20H6V2zm3 4h6m-6 4h6m-6 4h4',
  },
  ...
  },
  {
    ...
    iconPath: 'M12 2a10 10 0 100 20 10 10 0 000-20zm0 3a7 7 0 017 7h-3a4 4 0 00-8 0H5a7 7 0 017-7z',
  },
  {
    id: 'route53', name: 'Amazon Route 53', shortName: 'Route 53', category: 'Networking',
    color: '#8C4FFF', description: 'Scalable DNS service',
    iconPath: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.94-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93z',
  },
  {
    ...
    iconPath: 'M12 2v4m0 12v4M4 12h3m10 0h3M12 6a6 6 0 110 12 6 6 0 010-12zm0 3a3 3 0 100 6 3 3 0 000-6z',
  },
  {
    ...
    iconPath: 'M4 6h16v12H4V6zm4 3v6m4-6v6m4-6v6',
  },
  {
    ...
    iconPath: 'M2 12h6m8 0h6M8 8v8m8-8v8M8 12h8',
  },
  {
    ...
    iconPath: 'M12 2a10 10 0 100 20 10 10 0 000-20zm0 5v10M7 12h10',
  },
  ...
  // ── Security ───────────────────────────────────────────────────────
  {
    ...
    iconPath: 'M12 2L4 5v6.09c0 5.05 3.41 9.76 8 10.91 4.59-1.15 8-5.86 8-10.91V5l-8-3zm0 5a2.5 2.5 0 110 5 2.5 2.5 0 010-5zm-4.5 9c0-2.5 3-3.5 4.5-3.5s4.5 1 4.5 3.5',
  },
  {
  ...
  },
  {
    ...
    iconPath: 'M12 2l8 4v6c0 5.55-3.84 10.74-8 12-4.16-1.26-8-6.45-8-12V6l8-4zm-2 10l-2-2-1.5 1.5L10 15l6-6-1.5-1.5L10 12z',
  },
  {
    id: 'kms', name: 'AWS KMS', shortName: 'KMS', category: 'Security',
    color: '#DD344C', description: 'Key management service',
    iconPath: 'M12.65 10a6 6 0 11-2.3 0H2v4h2v3h3v-3h3.35M17 10a3 3 0 100 .001',
  },
  {
  ...
  // ── AI/ML ──────────────────────────────────────────────────────────
  {
    ...
    iconPath: 'M12 2a10 10 0 100 20 10 10 0 000-20zm-1 4h2v2h2v2h-2v2h-2v-2H9V8h2V6zm-3 8h8v2H8v-2zm2 4h4v2h-4v-2z',
  },
  {
    id: 'bedrock', name: 'Amazon Bedrock', shortName: 'Bedrock', category: 'AI/ML',
    color: '#01A88D', description: 'Foundation models as a service',
    iconPath: 'M12 2L3 7v10l9 5 9-5V7l-9-5zm0 2.5l6.5 3.6v7.3L12 19l-6.5-3.6V8.1L12 4.5z',
  },
  {
  ...
  // ── Analytics ──────────────────────────────────────────────────────
  {
    ...
    iconPath: 'M7 4c5 0 5 5 0 5s5 0 5 5c0 5-5 5-5 5m10-15c-5 0-5 5 0 5s-5 0-5 5c0 5 5 5 5 5',
  },
  {
    id: 'athena', name: 'Amazon Athena', shortName: 'Athena', category: 'Analytics',
    color: '#8C4FFF', description: 'Query data in S3 using SQL',
    iconPath: 'M12 2L4 6v12l8 4 8-4V6l-8-4zm0 2l6 3-6 3-6-3 6-3z',
  },
  {
    id: 'glue', name: 'AWS Glue', shortName: 'Glue', category: 'Analytics',
    color: '#8C4FFF', description: 'ETL service',
    iconPath: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM8 16l-2-2 2-2 1.5 1.5L8 15l1.5 1.5L8 16zm8 0l-1.5-1.5L16 13l-1.5-1.5L16 10l2 2-2 2v2z',
  },
  {
    ...
    iconPath: 'M15.5 14h-.79l-.28-.27A6.47 6.47 0 0016 9.5 6.5 6.5 0 109.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z',
  },
  ...
  },
  {
    ...
    iconPath: 'M12 2l-8 4v12l8 4 8-4V6l-8-4zm-2 8l2-2 2 2-2 2-2-2zm0 4l2 2 2-2',
  },
  {
    ...
    iconPath: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-5-9l2-2 3 3 5-5 2 2-7 7-5-5z',
  },
  {
  ...
  // ── Integration ────────────────────────────────────────────────────
  {
    ...
    iconPath: 'M4 4h16v16H4V4zm3 4h10v2H7V8zm0 4h10v2H7v-2zm0 4h6v2H7v-2z',
  },
  {
    id: 'sns', name: 'Amazon SNS', shortName: 'SNS', category: 'Integration',
    color: '#E7157B', description: 'Pub/sub messaging service',
    iconPath: 'M12 2L4 7v10l8 5 8-5V7l-8-5zm0 4l4 2.5v5L12 16l-4-2.5v-5L12 6z',
  },
  {
    ...
    iconPath: 'M12 2v4m0 12v4m-6-6l-4 4m16-4l-4 4M6 6L2 2m16 4l4-4M12 8a4 4 0 100 8 4 4 0 000-8z',
  },
  {
    ...
    iconPath: 'M4 4l8 4 8-4M4 12l8 4 8-4M4 20l8-4 8 4M12 8v4m0 4v4',
  },
  {
    id: 'mq', name: 'Amazon MQ', shortName: 'MQ', category: 'Integration',
    color: '#E7157B', description: 'Managed message broker',
    iconPath: 'M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm-8 6l-4 4h3v4h2v-4h3l-4-4z',
  },
  ...
  // ── Developer Tools ────────────────────────────────────────────────
  {
    ...
    iconPath: 'M4 6h4v12H4V6zm6 0h4v12h-4V6zm6 0h4v12h-4V6z',
  },
  {
    ...
    iconPath: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3 0 1.12-.61 2.09-1.5 2.61v2.89h-3V10.61C9.61 10.09 9 9.12 9 8c0-1.66 1.34-3 3-3zm-3 11.61c-.89-.52-1.5-1.49-1.5-2.61h3v1.5h3V14h3c0 1.12-.61 2.09-1.5 2.61V19h-3v-2.39h-3V19H9v-2.39z',
  },
  {
    id: 'codebuild', name: 'AWS CodeBuild', shortName: 'CodeBuild', category: 'Developer Tools',
    color: '#C925D1', description: 'Build and test code',
    iconPath: 'M12 2L4 5v6.09c0 5.05 3.41 9.76 8 10.91 4.59-1.15 8-5.86 8-10.91V5l-8-3zm-1.06 13.54L7.4 12l1.41-1.41 2.12 2.12 4.24-4.24 1.41 1.41-5.64 5.66z',
  },
  {
