...
<template>
  <div data-testid="management-view" class="flex h-full flex-col overflow-hidden bg-background">
    <!-- Topbar -->
    ...
    <div class="flex-1 overflow-y-auto p-4">
      <div
        class="grid gap-4 auto-rows-[minmax(280px,auto)] grid-cols-1 md:grid-cols-2"
        @dragover.prevent
      >
        <div
          ...
          :class="[
            widget.size === 'full' ? 'md:col-span-2' : 'col-span-1',
